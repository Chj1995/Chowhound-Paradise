...
@interface DGCCycleListDishContentCell ()
{
...
@end
@implementation DGCCycleListDishContentCell
...
-(void)setupSubView
{
    subView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kListDishCellHeight - 0.5)];
