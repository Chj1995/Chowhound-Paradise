...
@interface DGCSpecialViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation DGCSpecialViewController
#pragma mark - 懒加载
...
-(void)setupMyNavigationBarView
{
    ...
    [navigationBarView setupTitleLableWithTitle:@"今日最新" TitleSize:17];
...
-(void)requestDataFromNetWorking
{
    ...
    NSDictionary *headerRequest = @{@"lon":@"113.961853",
                                @"client":@"4",
                                @"imei":@"99000566557828",
    ...
    NSMutableString *urlStr = [NSMutableString stringWithFormat:@"http://api.douguo.net/recipe/simplerecipe/%ld/20",_currentPage];
    
   [HttpRequest Post:urlStr paramters:@"id=5&client=4" dictionary:headerRequest success:^(id responseObject) {
...
-(void)handleDataWithObject:(id)responseObject
{
    ...
    for (NSDictionary *dic in list)
    {
        ...
        model.picUrl = dic[@"r"][@"p"];
        model.vc = dic[@"r"][@"vc"];
        model.fc = dic[@"r"][@"fc"];
        model.picTitle = dic[@"r"][@"n"];
        ...
        {
            model.desc = dic[@"r"][@"cookstory"];
        }
        model.picId = dic[@"r"][@"id"];
        model.userAvatar = dic[@"r"][@"a"][@"p"];
        model.userVip = [NSString stringWithFormat:@"%@",dic[@"r"][@"a"][@"v"]];
        model.userName = dic[@"r"][@"a"][@"n"];
        model.type = dic[@"type"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.modelFrame = self.listDataSource[indexPath.row];
